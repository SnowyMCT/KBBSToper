...
public class SQLiter extends SQLer {
	...
	public String getUrl() {// 获取数据库url
		String folder = KBBSToper.getInstance().getDataFolder().getPath();// 获取插件文件夹
	...
	protected void connect() {
		...
		try {
			...
			KBBSToper.getInstance().getLogger().log(Level.WARNING, Message.FAILEDCONNECTSQL.getString(), e);
		}
	}
